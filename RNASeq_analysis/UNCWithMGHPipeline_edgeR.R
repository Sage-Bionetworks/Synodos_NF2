...
batch1 <- synGet("syn9779230")@filePath
...
groupbatch1 = factor(c(1,1,1,2,2,2,3,3,3,4,4,4,4,5,9,5,5,6,6,6,7,7,7,8,8,8))
...
synStore(File(paste(prefix,"_MDplot.logcpm.pdf",sep=""), parentId="syn9884466"), used = "syn9779230", executed = this.file)
synStore(File(paste(prefix,"_MDSplot.logcpm.pdf",sep=""), parentId="syn9884466"), used = "syn9779230", executed = this.file)
synStore(File(paste(prefix,"_MDSplot.pdf",sep=""), parentId="syn9884466"), used = "syn9779230", executed = this.file)
synStore(File(paste(prefix,"_samplesimilarity_edgeR.pdf",sep=""), parentId="syn9884466"), used = "syn9779230", executed = this.file)
synStore(File(paste(prefix,"_MeanVariance.pdf",sep=""), parentId="syn9884466"), used = "syn9779230", executed = this.file)
synStore(File(paste(prefix,"_BCVplot.pdf",sep=""), parentId="syn9884466"), used = "syn9779230", executed = this.file)
synStore(File(paste(prefix,"_QLDisplot.pdf",sep=""), parentId="syn9884466"), used = "syn9779230", executed = this.file)
synStore(File(paste(prefix,"_edgeR_qlf_qqplot.png",sep=""), parentId="syn9884466"), used = "syn9779230", executed = this.file)
synStore(File(paste(prefix,"_edgeR_qlf_plotsmear.png",sep=""), parentId="syn9884466"), used = "syn9779230", executed = this.file)
synStore(File(paste(prefix,"_volcanoplot.png"), parentId="syn9884466"), used = "syn9779230", executed = this.file)

synStore(File(paste(prefix,"_edgeR_quasilikelihoodFtest.txt",sep=""), parentId="syn9884467"), used = "syn9779230", executed = this.file)

}

prefix <- "HS01DMSOvsHS11DMSO"
controlCol <- c(10,11,12,13)
treatmentCol <- c(14,16,17)
contrast = c(0,0,0,-1,1,0,0,0,0)
