...
thisScriptURL = "https://github.com/Sage-Bionetworks/Synodos_NF2/blob/master/R_Scripts/2_combined_studies_enrichment_analysis.R"
...
pathway_ssGSEA_enrichment_scores <- merge_studies(pathway_ssGSEA_enrichment_scores)
...
pathway_GSVA_enrichment_scores <- merge_studies(pathway_GSVA_enrichment_scores)
