...
##heatmap of median correlation by cancer/synodos sample

```{r, echo=FALSE, fig.height=8, fig.width=8, message=FALSE, warning=FALSE}

cors4<-mclapply(colnames(cors2)[1:32], function(i){
...
cors4<-ldply(cors4)
rownames(cors4) <- colnames(cors2)[1:32]
library(pheatmap)
library(viridis)

pheatmap(cors4, color =  plasma(100), cellwidth = 10, cellheight = 10, border_color = NA)
