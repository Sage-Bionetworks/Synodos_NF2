...
p1 <- p1 + geom_line(data = HS_doseResp, aes(x = fittedX+6, y = fittedY*100, colour = Cell.Type, group = cellLine, linetype = Species))
...
p1
ggsave(filename = "Schwannoma_drug_response_2Dplot_DOTS.pdf",width = 8, height = 4)
```
