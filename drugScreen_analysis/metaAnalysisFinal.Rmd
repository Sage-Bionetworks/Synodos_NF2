...
pheatmap(mat = scale(simp.overlap), cluster_rows = TRUE, annotation_row = metadata %>% select(tumorType, NF2Status, organism), color = wes, cellwidth = 12, cellheight = 12, border_color = 'grey', main = 'Area Under the Curve (AUC)')

pheatmap(mat = scale(simp.m[1:7,]), cluster_rows = TRUE, annotation_row = metadata[1:7,] %>% select(tumorType, NF2Status, organism), color = wes, cellwidth = 12, cellheight = 12, border_color = 'grey', main = 'Area Under the Curve (AUC)')
...
pheatmap(mat = log(ic50.overlap), cluster_rows = TRUE, annotation_row = metadata2 %>% select(tumorType, NF2Status, organism), color = wes, cellwidth = 12, cellheight = 12, border_color = 'grey', main = 'log(IC50)')

pheatmap(mat = log(ic50.m[1:7,]), cluster_rows = TRUE, annotation_row = metadata2[1:7,] %>% select(tumorType, NF2Status, organism), color = wes, cellwidth = 12, cellheight = 12, border_color = 'grey', main = 'log(IC50)')
