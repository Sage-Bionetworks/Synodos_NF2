...
myColors <- c("#384DEA", "#EC91D8", "#BF2B2B")
...
p2 <- p2 + geom_point(aes(color=Cell.Type), size = 0.1) 
p2 <- p2 + scale_color_brewer(type = "qual", palette = 2, direction = 1)
p2 <- p2 + geom_line(data = SYN_doseResp_r, aes(x = fittedX+6, y = fittedY*100, colour = Cell.Type, group = cellLine))
